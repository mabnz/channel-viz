(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'xfpvWtKKKmngfc1tyrGuSltxnAnGg52Qnj4O0bFEdabQvU7a', // Unique master Xively API key to be used as a default
		defaultFeeds	= [2112122796], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Temperature is big business', // Replaces Xively logo in the header
		dataDuration	= '', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= 'FFA500', // CSS HEX value of color to represent data (omit leading #)
